...
Elixir поддерживает Perl-совместимые регулярные выражения (PCRE, Perl Compatible Regular Expressions), поэтому мы можем добавить `i` в конец нашей строковой метки, чтобы отключить чувствительность к регистру.
...
Но в чём разница? Отличие такое же, как в строковых метках списка символов, которые мы уже рассмотрели ранее &mdash; интерполяция и экранирование. 
...
Однако, между этими примерами нет никакой разницы. 
Опять же, разница заключается в интерполяции и экранировании.
